...
description: >
  Adams Events is a complete wedding and event planning company specializing in
  elegant decorations, creative stage setups, and memorable celebrations.
  From intimate family functions to grand weddings and special occasions,
  we handle every detail with creativity, professionalism, and care.

target_audience: >
  Couples, families, corporate clients, and organizations looking for
  professional wedding planning, event decoration, stage design, and
  complete event management services.

unique_value_proposition: >
  A complete event solution under one roof, combining creative decoration,
  elegant designs, professional planning, and personalized execution to turn
  every celebration into a memorable experience.
...
location:
  ...
  google_maps_embed_url: "https://www.google.com/maps?q=Thiruvalla,+Pathanamthitta,+Kerala&output=embed"
...
services:
  ...
  - name: "Wedding Planning"
    summary: "Complete wedding planning and coordination from concept to celebration."
    features:
  ...
  - name: "Wedding Decorations"
    ...
    features:
      - "Stage Decoration"
      - "Floral & Hanging Decorations"
      - "Entrance & Venue Styling"
    pricing: "Request Quote"

  - name: "Stage & Mandap Design"
    summary: "Creative stage and mandap setups that create a stunning focal point."
    features:
  ...
  - name: "Reception & Engagement Decoration"
    summary: "Beautiful setups for engagements, receptions, and pre-wedding celebrations."
    features:
      - "Backdrop Design"
      - "Floral Arrangements"
      - "Theme-Based Styling"
  ...
  - name: "Birthday & Private Events"
    summary: "Creative decorations and event setups for birthdays and private celebrations."
    features:
      - "Theme Decorations"
  ...
  - name: "Corporate & Special Events"
    summary: "Professional event planning and decoration for corporate and special occasions."
    features:
  ...
  - name: "Lighting & Special Effects"
    summary: "Atmospheric lighting and visual effects that elevate the entire venue."
    features:
  ...
  - name: "Floral & Venue Styling"
    summary: "Premium floral arrangements and venue styling tailored to your occasion."
    features:
      - "Fresh & Artificial Floral Designs"
      - "Ceiling & Hanging Installations"
      - "Table & Venue Styling"
    pricing: "Request Quote"
