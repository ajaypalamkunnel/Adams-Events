...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteConfig.business_name} | Complete Wedding & Event Planners in Thiruvalla, Pathanamthitta`,
  ...
  openGraph: {
    ...
    title: `${siteConfig.business_name} — A Complete Event Company`,
    description: siteConfig.description,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Adams Events Wedding and Event Planning Stage Decoration",
      },
    ],
  },
  twitter: {
  ...
  icons: {
    icon: "/assets/Adams_logo.png",
    shortcut: "/assets/Adams_logo.png",
    apple: "/assets/Adams_logo.png",
  },
  alternates: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${serifFont.variable} ${sansFont.variable} ${accentFont.variable}`}>
      ...
      <body className="font-sans antialiased selection:bg-brand-purple selection:text-white">
        <ThemeProvider>
          <SmoothScroll>
